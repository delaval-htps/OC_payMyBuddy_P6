...
public class CustomOAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        if (existedUser.isPresent()) {
            ...
            Optional<OAuth2Provider> oAuth2ProviderUser = oAuth2ProviderService
                    .getOAuht2ProviderByEmail(currentUser.getEmail());
            ...
            if (oAuth2ProviderUser.isPresent()) {
                ...
                newOAuth2Provider.setProviderUserId(Long.parseLong(user.getClientId().toString()));
                ...
                if (enumProvider != null) {
                    ...
                    throw new OAuth2ProviderNotFoundException("the Oauht2Provider is not approuved by paymybuddy.");
                }
